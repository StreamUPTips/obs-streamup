...
## Bug Fixes
- **Toolbar Spacing On The Right Side Of The Bar** - The StreamUP theme was padding the toolbar on the side nearest the edge of the window. Dock it right and the gap went on the right, holding the buttons away from the edge you are actually throwing the mouse at. The spacing now goes on the side facing the rest of OBS, worked out per dock position, so the bar sits tight to the edge wherever you put it.
