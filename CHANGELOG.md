...
### Improvements
- Toolbar spacers resize while you edit them. Click a spacer in the configurator and the size box edits that spacer directly. The list draws it at its real width and the toolbar updates live as you change the number. Cancel puts everything back
